package org.personDetail;

/**
 * This class is optional and represents the configuration for the personDetail module.
 * By exposing simple getter/setter/adder methods, this bean can be configured via content2bean
 * using the properties and node from <tt>config:/modules/personDetail</tt>.
